...
AAPL = readmatrix('data/AAPL.csv', 'Range','F2:F252');
AMZN = readmatrix('data/AMZN.csv','Range','F2:F252');
MSFT = readmatrix('data/MSFT.csv','Range','F2:F252');
GOOG = readmatrix('data/GOOG.csv','Range','F2:F252');
[m,n] = size(AMZN);
...
Np = 100;                            % Population Size(Number of portfolios)
